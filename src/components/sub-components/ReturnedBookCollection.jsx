...
const ReturnedBookCollection = () => {
    ...
    const filterReturnedBookCollection = returnedBookCollection.filter(item => 
    ...
    return (
        <div className="px-5 py-10 min-h-screen">
            <div className="flex items-center justify-center">
                <h1 className="text-white text-3xl md:text-4xl lg:text-5xl font-bold mb-10">Returned Book List</h1>
            </div>
            <div className="max-w-7xl mx-auto">
                <div className="relative">
                    ...
                    <input
                        ...
                        type="text"
                        placeholder="Search Returned Book Here..."
                ...
                <div className="mt-5">
                    <div className="overflow-x-auto">
                        <table className="table">
                            ...
                            {filterReturnedBookCollection.length > 0 ? (
                                <tbody className="bg-white bg-opacity-10 text-center text-lg text-white">
                                    {filterReturnedBookCollection.map(item => (
                                        <ReturnedBookData key={item._id} item={item} handleDeleteReturnedBook={handleDeleteReturnedBook} />
                                    ))}
                                </tbody>
                            ) : (
                                <tbody className="bg-white bg-opacity-10 text-center text-lg text-white">
